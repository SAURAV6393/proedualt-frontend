...
export default function PortfolioPage({ params }) {
    ...
    if (!portfolioData) {
        return <main className="min-h-screen flex items-center justify-center p-8 animated-background"><p className="text-red-400 text-xl">Profile not found or is not public.</p></main>;
    }
